...
function ProductApp({ user, onLogout }) {
  /* ── Mock data (Phase 3 will replace with API) ── */
  const today = [
    { label: 'Calories', current: 1450, target: 2100, unit: 'kcal', color: '#40916C' },
    { label: 'Protein', current: 92, target: 130, unit: 'g', color: '#FFB703' },
    { label: 'Carbs', current: 168, target: 210, unit: 'g', color: '#E76F51' },
    { label: 'Fat', current: 48, target: 65, unit: 'g', color: '#6366F1' },
  ];
  const meals = [
    { name: 'Avocado toast + eggs', time: '8:15 AM', type: 'breakfast', kcal: 420, protein: 22 },
    { name: 'Grilled chicken salad', time: '12:30 PM', type: 'lunch', kcal: 580, protein: 46 },
    { name: 'Greek yogurt & berries', time: '3:45 PM', type: 'snack', kcal: 180, protein: 14 },
    { name: 'Salmon w/ roasted veggies', time: '7:00 PM', type: 'dinner', kcal: 520, protein: 38 },
  ];
  const weekPlan = [
    { day: 'Mon', meals: ['Oatmeal + whey', 'Turkey wrap', 'Apple + almonds', 'Chicken stir-fry'] },
    { day: 'Tue', meals: ['Smoothie bowl', 'Tuna salad', 'Protein bar', 'Beef & broccoli'] },
    { day: 'Wed', meals: ['Egg muffins', 'Quinoa bowl', 'Cottage cheese', 'Baked cod + rice'] },
    { day: 'Thu', meals: ['Greek yogurt', 'Chicken salad', 'Mixed nuts', 'Lentil curry'] },
    { day: 'Fri', meals: ['Pancakes', 'Soba noodles', 'Hummus + veg', 'Grilled fish'] },
  ];
  const insights = [
    { icon: <Activity size={16} />, label: 'Steps (sync)', value: '6,842', sub: 'Avg 7.2k this week' },
    { icon: <Heart size={16} />, label: 'Protein trend', value: '+12%', sub: 'vs last week' },
    { icon: <Apple size={16} />, label: 'Apple Health', value: 'Synced', sub: '2 min ago' },
  ];
